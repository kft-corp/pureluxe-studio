...
import { getRolePermissionsOverview } from "@/lib/team/role-permissions-overview";

/** Roles, permission catalog, and current grants matrix. */
export async function GET() {
  try {
    ...
    const overview = await getRolePermissionsOverview(canManage);
